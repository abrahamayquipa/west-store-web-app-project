    ...
    return (
        <Link to={`/product/${props.id}`}>
            ...
            {data.title ? (
                    ...
                    <section className='lg:my-auto lg:ml-4 lg:w-4/6'>
                        ...
                        <section className='flex'>
                            {data.price && (
                                <section className='flex items-center lg:my-1'>
                                    ...
                                    {data.price.oldPrice && <span className='lg:mx-2 text-2xl lg:text-3xl text-gray-400 font-semibold line-through tracking-tightermx-1'>{`$${data.price.oldPrice}`}</span>}
                        ...
                        <section className='mt-4'>
                            ...
                            <section className='flex flex-wrap'>
                                {[
                                    { name: 'brown', color: '#4F4631' },
                                    { name: 'green', color: '#314F4A' },
                                    { name: 'purple', color: '#31344F' },
                                    { name: 'beish', color: '#E5E2D8' },
                                    { name: 'pink', color: '#FAC6C6' }
                ...
                <article className='container flex px-8 mx-auto my-80 sm:my-96'>
